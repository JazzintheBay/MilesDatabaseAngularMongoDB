...
//         "eventGroup" is the purpose of the eventGroup
    ...
    public String editEventGroup(String id, String purpose, String category,
        ...
        setQuery.append("$set", newEventGroup);
        Document searchQuery = new Document().append("_id", new ObjectId(id));

        try {
            eventGroupCollection.updateOne(searchQuery, setQuery);
    ...
    public void deleteEventGroup(String id){
        Document searchQuery = new Document().append("_id", new ObjectId(id));
        System.out.println("EventGroup id: " + id);
        try {
            eventGroupCollection.deleteOne(searchQuery);
            ObjectId theID = searchQuery.getObjectId("_id");
            System.out.println("Succesfully deleted eventGroup with ID: " + theID);
